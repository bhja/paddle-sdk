...
@Setter @Getter @NoArgsConstructor public class Transaction {
    ...
    @JsonProperty("discount_id") private String discountId;
    ...
    @JsonProperty("billed_at") private LocalDateTime billedAt;
