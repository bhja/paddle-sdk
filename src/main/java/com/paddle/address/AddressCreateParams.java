...
@Getter @Setter @NoArgsConstructor public class AddressCreateParams {

    @JsonProperty("first_line") private String firstLine;
    @JsonProperty("second_line") private String secondLine;
    private String city;
